# This file contains deprecated code and tests that don't pass anymore
# (likely because they rely on previous versions of the functions)

# From tests/testthat/test-addStages.R
...
test_that("Overlap of TNM codes", {
  ...
  expect_true(any(intersection_codelists > 0))
